...
public class ServerConfig {
    ...
    public static final String serverName = "Scania";
    public static final String eventMessage = "MapleStoryLa v175!!";
    ...
    public static final String scrollingMessage = "Welcome to MapleStoryLa v175!!";
    ...
    public static final int CASH_DROP_RATE = 10; //out of 100
