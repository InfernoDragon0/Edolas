...
public class WorldConstants {
    ...
    public static final int gmserver = -45; // -1 = no gm server
    ...
    public static enum WorldOption {
        ...
        Reboot(45, 1, 1, 1, (byte) 0, false, false, 19),
        ...
        public static final String recommendedmsg = "        Join the better world of " + getById(recommended).name() + ",       the newest world! (If you have friends who play.)";
