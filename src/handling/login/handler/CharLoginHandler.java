...
public class CharLoginHandler {
	...
	public static void CheckCharName(final String name, final MapleClient c) {
		...
		boolean nameUsed = false; // change this back to true
	...
	public static void CreateChar(final LittleEndianAccessor slea, final MapleClient c) {
		...
		case Adventurer: // Adventurer
			...
			// newchar.sendWelcome();
			// newchar.applyBlackBlessingBuff(bottom);
			// newchar.changeMap(100000000, bottom);
			newchar.getStat().maxhp += 270; //Beginner 10 levels
			newchar.getStat().maxmp += 210;
			newchar.getStat().hp += 270; //Beginner 10 levels
