...
public class MapleAchievements {
    ...
    protected MapleAchievements() {
        ...
        achievements.put(31, new MapleAchievement("got over 1 000 000 mesos", 10, true));
        ...
        achievements.put(42, new MapleAchievement("got over 3 000 000 000 mesos", 40, true));
